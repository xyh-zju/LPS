 ...
 */
const RadioRegisters_t RadioRegsInit[] = {NULL};

/*!
 * \brief Holds the internal operating mode of the radio. sleep, STDBY, Rx, Tx, FS, etc. Refer to DS_P67
 */
 SX1280_RadioOperatingModes_t OperatingMode;
...
{
    //sets the transceiver in sniff mode, so that it regularly looks for new packets
    uint8_t buf[5];
    buf[0] = Step;
